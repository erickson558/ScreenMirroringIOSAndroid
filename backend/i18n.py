...
_MESSAGES: dict[str, dict[str, str]] = {
    LANGUAGE_ES: {
        ...
        "title_pick_uxplay_folder": "Selecciona la carpeta de UxPlay",
        "status_uxplay_path_updated": "Ruta de UxPlay actualizada.",
        "status_uxplay_folder_updated": "Carpeta de UxPlay actualizada.",
        "error_uxplay_folder_invalid": "La carpeta seleccionada no contiene uxplay.exe.",
        "action_install_uxplay": "[PISTA] Instalando runtime de UxPlay en: {target}",
        "action_install_uxplay_short": "Instalando UxPlay",
        "status_uxplay_installed": "UxPlay instalado correctamente en: {target}",
        ...
        "action_repair_network": "Reparando red AirPlay...",
        "status_repair_network_done": "Reparación completada. Intenta conectar desde iPhone.",
        "error_repair_network_failed": "No se pudo completar la reparación de red.",
    ...
    LANGUAGE_EN: {
        ...
        "title_pick_uxplay_folder": "Select UxPlay folder",
        "status_uxplay_path_updated": "UxPlay path updated.",
        "status_uxplay_folder_updated": "UxPlay folder updated.",
        "error_uxplay_folder_invalid": "Selected folder does not contain uxplay.exe.",
        "action_install_uxplay": "[HINT] Installing UxPlay runtime to: {target}",
        "action_install_uxplay_short": "Installing UxPlay",
        "status_uxplay_installed": "UxPlay installed successfully at: {target}",
        ...
        "action_repair_network": "Repairing AirPlay network...",
        "status_repair_network_done": "Repair completed. Try connecting again from iPhone.",
        "error_repair_network_failed": "Could not complete network repair.",
