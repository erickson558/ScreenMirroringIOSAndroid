...
class CaptureService:
    ...
    _WINDOW_REGION_STABILIZATION_DELAY_SECONDS = 0.05
    _WINDOW_TRACK_POLL_SECONDS = 0.08
    _WINDOW_TRACK_MOVE_THRESHOLD_PX = 12
    _WINDOW_TRACK_SIZE_TOLERANCE_PX = 24
    _WINDOW_TRACK_ROTATE_COOLDOWN_SECONDS = 0.4
